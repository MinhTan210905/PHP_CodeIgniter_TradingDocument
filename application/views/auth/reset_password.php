...
<head>
    ...
    <title>Đặt lại mật khẩu | HCMUE BookSwap</title>
...
<div class="auth-panel-left">
    <div class="left-content">
        ...
        <h1 class="left-headline">Mật khẩu mới ✨</h1>
        <p class="left-subline" style="color:rgba(255,255,255,0.85);font-size:1.05rem;line-height:1.6;">Hãy tạo một mật khẩu mới mạnh mẽ để bảo vệ tài khoản của bạn.</p>
    </div>
</div>
        ...
        <form action="<?= site_url('auth/reset_password_post') ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-wrap">
                    ...
                    <input type="password" class="form-control" name="password" id="pwd" required
                           ...
                           placeholder="Nhập mật khẩu mới (ít nhất 6 ký tự, cả chữ và số)">
                    <button type="button" class="toggle-pwd" onclick="togglePwd('pwd', 'pwd-icon')">
            ...
            <div class="mb-4">
                ...
                <div class="input-wrap">
                    ...
                    <button type="button" class="toggle-pwd" onclick="togglePwd('cpwd', 'cpwd-icon')">
                        <i class="fas fa-eye" id="cpwd-icon"></i>
                    </button>
                </div>
            </div>
