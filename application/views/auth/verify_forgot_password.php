...
<head>
    ...
    <title>Xác minh mã OTP | HCMUE Pass Sách</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .form-control {
            height: 52px; border: 2px solid #E2E8F0; border-radius: 14px;
            font-size: 1.2rem; font-weight: 700; color: var(--text-dark); transition: all 0.2s;
...
<div class="auth-panel-left">
    <div class="left-content">
        ...
        <h1 class="left-headline">Xác minh<br>Email ✉️</h1>
        <p class="left-subline" style="color:rgba(255,255,255,0.85);font-size:1.05rem;line-height:1.6;">Chúng tôi đã gửi một mã OTP gồm 6 chữ số đến email của bạn. Vui lòng kiểm tra hộp thư.</p>
    </div>
</div>
...
<div class="auth-panel-right">
    <div class="auth-form-wrap">
        ...
        <p class="auth-subtitle">Mã xác nhận gồm 6 chữ số đã được gửi đến email của bạn. Mã sẽ hết hạn sau 5 phút.</p>
        ...
        <form action="<?= site_url('auth/verify_forgot_password_post') ?>" method="POST">
            ...
            <button type="submit" class="btn-login">
                <i class="fas fa-check-circle"></i> Xác minh mã OTP
            </button>
        </form>
    </div>
</div>
